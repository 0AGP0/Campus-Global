...
import { mapMegaNavItem, type SanityMegaNavItem } from "@/lib/sanity/types";
...
function mergeArticleNavLinks(
  base: MegaNavItem[],
  navArticles: Awaited<ReturnType<typeof import("./articles").getAllCmsArticles>>,
): MegaNavItem[] {
